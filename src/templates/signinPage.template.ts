export default `
    <div class="login__container">
      <div class="login__wrapper">
        <h1>Sign up</h1>
        <form action="" class="login__form" id="register-form">
          <div class="input__wrapper">
            ...
            {{> loginInputPartial inputType="password" inputDesc="Password" inputName="password" errorMessage="Password too weak"}}
            {{> loginInputPartial inputType="password" inputDesc="Confirm password" inputName="confirm_password" errorMessage="Passwords dont match"}}
          </div>
